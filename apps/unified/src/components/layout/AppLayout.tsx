...
const NAV_ITEMS = [
  ...
  { to: '/notifications',    icon: '🔔', label: 'Powiadomienia',       roles: ['SUPER_ADMIN'] },
  { to: '/owner',            icon: '⚙️', label: 'Panel Operatora',      roles: ['OWNER'] },
  { to: '/notification-rules', icon: '🔔', label: 'Reguły powiadomień',   roles: ['OWNER'] },
...
export function AppLayout({ user, onLogout, children }: Props) {
  ...
  const SidebarContent = ({ mobile = false }: { mobile?: boolean }) => (
    <>
      ...
      {/* Language + Bell — desktop sidebar bottom */}
